---
title: "Assessing the effect of coverage on estimates of Fst and population structure for empirical data"
author: "Arne Jacobs"
output: 
  github_document:
    toc: true
...
Data from: Van Belleghem, S. M., Rastas, P., Papanicolaou, A., Martin, S. H., Arias, C. F., Supple, M. A., … Papa, R. (2017). Complex modular architecture around a simple toolkit of wing pattern genes. Nature Ecology & Evolution, 1(3), 52.
...
Downsampling of bam files to varying coverages (8x, 4x, 2x, 1x, 0.5x, 0.25x):
```{bash, eval = F}
...
Used filters:
* minCov: 0.1 x N.ind = 5
* maxCov: cov*N.ind + (2 * cov*N.ind) =  1272
* minInd: 75% = 40
* minQ = 30
...
Used filters:
* minCov: 0.1 x N.ind = 5
* maxCov: cov*N.ind + (2 * cov*N.ind) = 636
* minInd: 75% = 40
* minQ = 30
...
Used filters:
* minCov: 0.1 x N.ind = 5
* maxCov: cov*N.ind + (2 * cov*N.ind) =  318
* minInd: 75% = 40
* minQ = 30
...
Used filters:
* minCov: 0.1 x N.ind = 5
* maxCov: cov*N.ind + (2 * cov*N.ind)  = 159
* minInd: 75% = 40
* minQ = 30
...
Used filters:
* minCov: 0.1 x N.ind = 5
* maxCov: cov*N.ind + (2 * cov*N.ind)  = 80
* minInd: 75% = 40
* minQ = 30
...
Used filters:
* minCov: 0.1 x N.ind = 5
* maxCov: cov*N.ind + (2 * cov*N.ind)  = 40
* minInd: 75% = 40
* minQ = 30
...
Correlation betwen the coverage and number of called SNPs (Quadratic model)
```{r, eval = FALSE}
