...
frequency_plot_combined <- joined_frequency_final_combined %>%
  ...
  scale_color_viridis_d(labels=c("LC-WGS with even coverage", "LC-WGS with uneven coverage"), begin = 0.75, end = 0) +
  scale_fill_viridis_d(labels=c("LC-WGS with even coverage", "LC-WGS with uneven coverage"), begin = 0.75, end = 0) +
  xlab("true frequency of derived allele") +
  ylab("estimated frequency") +
  theme_cowplot() +
  theme(strip.text = element_text(size=20),
