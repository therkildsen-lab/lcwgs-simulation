---
title: "Simulation workflow for two-population simulation with mutations under selection at fixed positions"
output: 
  github_document: 
    toc: true
---
...
For this step, I used GATK's GL model (`-GL 2`), and applied a minimum depth filter but no SNP p-value or MAF filter.
