...
ggsave("../figures/two_pop_sim_fixed_m2_pos_lower_s_lower_r_fixed_windowed_fst.png", fst_plot_new, width = 15, height = 7, units = "in", pointsize = 20)
```
...
fst_plot_poolseq <-mutate(maf_final, coverage="RAD") %>%
  ...
  theme_cowplot() +
  theme(text = element_text(size=20))
ggsave("../figures/two_pop_sim_fixed_m2_pos_lower_s_lower_r_fixed_poolseq_windowed_fst.png", fst_plot_poolseq, width = 15-0.315, height = 2.5, units = "in", pointsize = 20)
```
...
<img src="../figures/two_pop_sim_fixed_m2_pos_lower_s_lower_r_fixed_poolseq_windowed_fst.png" width="4405" />
