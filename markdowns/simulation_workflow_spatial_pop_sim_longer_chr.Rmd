---
title: "Simulation workflow for two dimensional spatial populations with a longer chromosome and associated PCA results"
output: 
  github_document: 
    toc: true
---
...
```{r pca_pcangsd, eval=T, warning=F, message=F, fig.height=6, fig.width=2.5}
...
```{r pca_cov_mat, eval=T, warning=F, message=F, fig.height=6, fig.width=2.5}
ggplot(pca_table_final,aes(x=PC1, y=PC2, color=population)) +
  geom_point() +
  facet_grid(coverage~sample_size, scales="free") +
  theme_bw() +
