...
``` r
write_tsv(thetas_final, "../neutral_sim/rep_1/angsd/thetas.tsv")
```
...
| -------: | --------: | --------: | --------: | --------: | --------: | --------: |
|     0.25 | 0.0029842 | 0.0031141 | 0.0032842 | 0.0034617 | 0.0036440 | 0.0037600 |
|     0.50 | 0.0031251 | 0.0033086 | 0.0034805 | 0.0036536 | 0.0037710 | 0.0038351 |
|     1.00 | 0.0033601 | 0.0035366 | 0.0036733 | 0.0037775 | 0.0038364 | 0.0038704 |
|     2.00 | 0.0036027 | 0.0037255 | 0.0037903 | 0.0038607 | 0.0038775 | 0.0038930 |
|     4.00 | 0.0037970 | 0.0038473 | 0.0038776 | 0.0039013 | 0.0039097 | 0.0039118 |
|     8.00 | 0.0038881 | 0.0039068 | 0.0039219 | 0.0039385 | 0.0039219 | 0.0039087 |
...
| coverage |         5 |        10 |        20 |        40 |        80 |       160 |
| -------: | --------: | --------: | --------: | --------: | --------: | --------: |
|     0.25 | 0.0023553 | 0.0021816 | 0.0020053 | 0.0019699 | 0.0020466 | 0.0021562 |
|     0.50 | 0.0024706 | 0.0023284 | 0.0023111 | 0.0023603 | 0.0024419 | 0.0025131 |
|     1.00 | 0.0028447 | 0.0027813 | 0.0027815 | 0.0028292 | 0.0028794 | 0.0029280 |
|     2.00 | 0.0033173 | 0.0033296 | 0.0033429 | 0.0033634 | 0.0033644 | 0.0033704 |
|     4.00 | 0.0036806 | 0.0036893 | 0.0037015 | 0.0036988 | 0.0036998 | 0.0036887 |
|     8.00 | 0.0038513 | 0.0038655 | 0.0038826 | 0.0038819 | 0.0038749 | 0.0038517 |
...
![](data_analysis_neutral_files/figure-gfm/unnamed-chunk-25-1.png)<!-- -->
...
![](data_analysis_neutral_files/figure-gfm/unnamed-chunk-25-2.png)<!-- -->
...
``` bash
nohup bash /workdir/lcwgs-simulation/shell_scripts/run_ngsld.sh > /workdir/lcwgs-simulation/nohups/run_ngsld.nohup &
nohup bash /workdir/lcwgs-simulation/shell_scripts/ld_decay.sh > /workdir/lcwgs-simulation/nohups/ld_decay.nohup &
```
...
for (sample_size in c(5, 10, 20, 40, 80, 160)) {
  estimated_decay_rate <- read_delim(str_c("/workdir/lcwgs-simulation/neutral_sim/rep_1/angsd/ld_decay_", sample_size, ".out"), skip = 3, col_names = FALSE, delim = " ", n_max = 6)[1:6,] %>%
...
ld_for_plotting %>%
  ...
  facet_grid(coverage ~ sample_size) +
  ggtitle("Fitted linkage decay model using ngsLD with the Samtools genotype likelihood model") +
...
![](data_analysis_neutral_files/figure-gfm/unnamed-chunk-35-1.png)<!-- -->
...
for (sample_size in c(5, 10, 20, 40, 80, 160)) {
  print(sample_size)
  for (coverage in c(0.25, 0.5, 1, 2, 4, 8)) {
    estimated_ld <- read_tsv(str_c("../neutral_sim/rep_1/angsd/bam_list_", sample_size, "_", coverage, "x.ld"), col_names =FALSE) %>%
...
write_tsv(estimated_ld_final, "../neutral_sim/rep_1/angsd/mean_ld_per_position.tsv")
```

``` r
estimated_ld <- read_tsv("../neutral_sim/rep_1/angsd/mean_ld_per_position.tsv")
estimated_ld %>%
  ...
  facet_grid(coverage ~ sample_size) +
  ggtitle("Linkage disequilibrium estimated using ngsLD with the Samtools genotype likelihood model") +
  cowplot::theme_cowplot() +
  labs(x = "physical distance (in kb)", y = "r-squared") +
...
![](data_analysis_neutral_files/figure-gfm/unnamed-chunk-37-1.png)<!-- -->
