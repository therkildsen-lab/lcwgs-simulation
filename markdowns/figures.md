...
error_plot_combined <- joined_frequency_final_combined %>%
  ...
  facet_grid(coverage~sample_size, switch = "y") +
...
ggsave("../figures/error_plot_combined.png", error_plot_combined, width = 45, height = 30, units = "cm", pointsize = 20)
```
...
<img src="../figures/error_plot_combined.png" width="5314" />
...
pca_plot <- filter(pca_table_final, coverage < 0.5) %>% 
  ...
  geom_point() +
  facet_grid(coverage~sample_size, scales="free", switch = "y") +
...
ggsave("../figures/spatial_pop_lower_m_cov_mat_pca.png", pca_plot, width = 32, height = 8, units = "cm", pointsize = 20)
```
...
<img src="../figures/spatial_pop_lower_m_cov_mat_pca.png" width="3779" />
...
two_pop_sim_fixed_m2_pos_lower_s_lower_r_fixed_windowed_fst_plot <- filter(fst_n_ind_final, coverage < 4, sample_size > 5, sample_size < 160) %>%
...
ggsave("../figures/two_pop_sim_fixed_m2_pos_lower_s_lower_r_fixed_windowed_fst.png", two_pop_sim_fixed_m2_pos_lower_s_lower_r_fixed_windowed_fst_plot, width = 15, height = 8, units = "in", pointsize = 20)
```

``` r
include_graphics("../figures/two_pop_sim_fixed_m2_pos_lower_s_lower_r_fixed_windowed_fst.png")
```

<img src="../figures/two_pop_sim_fixed_m2_pos_lower_s_lower_r_fixed_windowed_fst.png" width="4500" />

#### Read in files for pooled seq

``` r
maf_final <- allele_count_to_fst("../two_pop_sim_fixed_m2_pos_lower_s_lower_r/rep_1/")
two_pop_sim_fixed_m2_pos_lower_s_lower_r_fixed_windowed_fst_plot_poolseq <-mutate(maf_final, coverage="RAD") %>%
  filter(sample_size > 5, sample_size < 160) %>%
  ggplot(aes(x=position/10^6, y=fst)) +
  ...
  theme_cowplot() +
  theme(text = element_text(size=20))
ggsave("../figures/two_pop_sim_fixed_m2_pos_lower_s_lower_r_fixed_poolseq_windowed_fst.png", two_pop_sim_fixed_m2_pos_lower_s_lower_r_fixed_windowed_fst_plot_poolseq, width = 15, height = 2.8, units = "in", pointsize = 20)
```

``` r
include_graphics("../figures/two_pop_sim_fixed_m2_pos_lower_s_lower_r_fixed_poolseq_windowed_fst.png")
```

<img src="../figures/two_pop_sim_fixed_m2_pos_lower_s_lower_r_fixed_poolseq_windowed_fst.png" width="4500" />
